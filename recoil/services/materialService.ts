...
export class MaterialService extends BaseServices {
    ...
    getAllMaterial = async () => {
        return await this.get(`/api/materialApi/get-all-material`).then(result => result).catch(err => err);
    };
    createMaterial = async (data: object) => {
        return await this.post(`/api/materialApi/create-material`, data).then(result => {
    ...
    editMaterial = async (data: object) => {
        return await this.put(`/api/materialApi/edit-material`, data).then(result => {
    ...
    deleteMaterial = async (id: any) => {
        return await this.post(`/api/materialApi/delete-material`, id).then(result => {
    ...
    getMaterialStatDetail = async (data: string) => {
        return await this.post(`/api/materialApi/edit-material`, { data }).then(result => result).catch(err => err)
    };
